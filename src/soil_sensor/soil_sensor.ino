// I2C Address: 0x20 (Soil moisture sensor node)
// Reads Grove Moisture Sensor via ADC and transmits soil humidity (0-100%) to controller (0x25)
...
void loop() {
    ...
    if (timer2_overflow_count >= TRANSMIT_INTERVAL) {
        ...
        // Grove Moisture Sensor: dry=0, wet=660
        scaledValue = (unsigned char)(100.0 * (sensorValue / 660.0));
